...
if (isset($_POST['cari'])) {
  ...
  $query = "SELECT * FROM `tb_laporan` WHERE tgl_laporan BETWEEN '$tglAwal' AND '$tglAkhir' ORDER BY tgl_laporan DESC";
  $result = mysqli_query($conn, $query); 
}else{
  // menampilkan data transaksi
  $query = "SELECT * FROM `tb_laporan` ORDER BY tgl_laporan DESC";
  $result = mysqli_query($conn, $query); 
}
?>
      ...
      <div class="col-12">
        <div class="card m-b-30">
          ...
          <form class="form-inline mr-auto w-100 navbar-search" action="" method="POST">
            ...
            <h2 class="mt-0 header-title" style="color:#87CEEB; text-align: center;">20 Laundry Shop</h2>
