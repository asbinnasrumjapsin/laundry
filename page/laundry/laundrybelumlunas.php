        ...
        <div class="card m-b-30">
          ...
          <div class="table-responsive">
            ...
            <table id="datatable" class="table table-bordered">
              ...
              $query = "SELECT * FROM `tb_laundry` INNER JOIN `tb_users` ON `tb_users`.`userid` = `tb_laundry`.`userid` INNER JOIN `tb_jenis` ON `tb_jenis`.`kd_jenis` = `tb_laundry`.`kd_jenis` WHERE status_pembayaran=0 ORDER BY `tb_laundry`.`id_laundry` DESC";
