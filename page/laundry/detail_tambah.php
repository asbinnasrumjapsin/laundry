                    ...
                    <div class="card card-info card-annoucement card-round">
                        <div class="card-body text-center">
                            <div class="icon-big text-center">
                                <i class="fa fa-print"  style="font-size: 100px;" ></i>
                            </div>
                                
                            <div class="card-detail">
                                <a class="btn btn-dark btn-rounded" href="page/cetak_transaksi_awal.php?id=<?= $id_laundry; ?>"  target="_blank">Cetak Nota Awal</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
					<div class="card card-success card-annoucement card-round">
						<div class="card-body text-center">
                            ...
                            <div class="card-detail">
                                <a class="btn btn-dark btn-rounded" href="?page=laundry&aksi=tambah/detail_rincian&idlaundry=<?= $id_laundry ?>">Isi Rincian Laundry</a>
                            </div>
						</div>
					</div>
				</div>
