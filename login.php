...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="assets/images/20logo.png" type="image/png"/>
        <title>Login 20 Laundry Shop</title>
    ...
    <style>
        .accountbg {
            background-image: url('assets/images/laudry.jpg');
            ...
            <div class="card">
                <div class="card-body">
                    <h3 class="text-center mt-0 m-b-15">
                        <a href="login.php"><img src="assets/images/20logo.png" width="200px"></a>
                    </h3>
                    <div class="p-3">
                        <h4 class="text-center mt-0 m-b-15">Login 20 Laundry Shop</h4>
